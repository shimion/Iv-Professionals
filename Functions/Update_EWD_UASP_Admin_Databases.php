...
function Edit_EWD_UASP_Appointment($Appointment_ID, $Appointment_Start_Time, $Appointment_End_Time, $Location_Name, $Location_Post_ID, $Service_Name, $Service_Post_ID, $Service_Provider_Name, $Service_Provider_Post_ID, $Appointment_Client_Name, $Appointment_Client_Phone, $Appointment_Client_Email, $Appointment_Reminder_Email_Sent, $Appointment_Confirmation_Received) {
	...
	$update = __("Appointment has been successfully edited.", 'ultimate-appointment-scheduling');
	return $update;
}
...
function EWD_UASP_UpdateOptions() {
	...
	if (isset($_POST['woocommerce_integration'])) {update_option("EWD_UASP_WooCommerce_Integration", $_POST['woocommerce_integration']);}
	if (isset($_POST['allow_paypal_prepayment'])) {update_option("EWD_UASP_Allow_Paypal_Prepayment", $_POST['allow_paypal_prepayment']);}
	if (isset($_POST['pricing_currency_code'])) {update_option("EWD_UASP_Pricing_Currency_Code", $_POST['pricing_currency_code']);}
	if (isset($_POST['allow_paypal_prepayment'])) {update_option("EWD_UASP_PayPal_Email_Address", $_POST['payPal_email_address']);}
	if (isset($_POST['allow_paypal_prepayment'])) {update_option("EWD_UASP_Thank_You_URL", $_POST['thank_you_url']);}
	...
	if ((get_option("EWD_UASP_Third_Party_Reminders") == "No" and $_POST['third_party_reminders'] == "Yes") or
		(get_option("EWD_UASP_Third_Party_Reminders") == "Yes" and $_POST['third_party_reminders'] == "No")) 
	...
	if (isset($_POST['sign_up_title_label'])) {update_option('EWD_Sign_Up_Title_Label',  $_POST['sign_up_title_label']);}
	if (isset($_POST['name_label'])) {update_option('EWD_Name_Label',  $_POST['name_label']);}
	if (isset($_POST['phone_label'])) {update_option('EWD_Phone_Label',  $_POST['phone_label']);}
	if (isset($_POST['email_label'])) {update_option('EWD_Email_Label',  $_POST['email_label']);}
	if (isset($_POST['service_title_label'])) {update_option('EWD_Service_Title_Label',  $_POST['service_title_label']);}
	if (isset($_POST['location_label'])) {update_option('EWD_Location_Label',  $_POST['location_label']);}
	if (isset($_POST['service_label'])) {update_option('EWD_Service_Label',  $_POST['service_label']);}
	if (isset($_POST['service_provider_label'])) {update_option('EWD_Service_Provider_Label',  $_POST['service_provider_label']);}
	if (isset($_POST['appointment_title_label'])) {update_option('EWD_Appointment_Title_Label',  $_POST['appointment_title_label']);}
	if (isset($_POST['appointment_date_label'])) {update_option('EWD_Appointment_Date_Label',  $_POST['appointment_date_label']);}
	if (isset($_POST['find_appointments_label'])) {update_option('EWD_Find_Appointments_Label',  $_POST['find_appointments_label']);}
	if (isset($_POST['book_appointment_label'])) {update_option('EWD_Book_Appointment_Label',  $_POST['book_appointment_label']);}
	if (isset($_POST['pay_in_advance_label'])) {update_option('EWD_Pay_In_Advance_Label',  $_POST['pay_in_advance_label']);}
	if (isset($_POST['proceed_to_payment_label'])) {update_option('EWD_Proceed_To_Payment_Label',  $_POST['proceed_to_payment_label']);}
	
	if (isset($_POST['uasp_signup_title_font'])) {update_option('EWD_UASP_Signup_Title_Font',  $_POST['uasp_signup_title_font']);}
    if (isset($_POST['uasp_signup_title_font_size'])) {update_option('EWD_UASP_Signup_Title_Font_Size',  $_POST['uasp_signup_title_font_size']);}
    if (isset($_POST['uasp_signup_title_font_color'])) {update_option('EWD_UASP_Signup_Title_Font_Color',  $_POST['uasp_signup_title_font_color']);}
    if (isset($_POST['uasp_signup_label_font'])) {update_option('EWD_UASP_Signup_Label_Font',  $_POST['uasp_signup_label_font']);}
    if (isset($_POST['uasp_signup_label_font_size'])) {update_option('EWD_UASP_Signup_Label_Font_Size',  $_POST['uasp_signup_label_font_size']);}
    if (isset($_POST['uasp_signup_block_color'])) {update_option('EWD_UASP_Signup_Block_Color',  $_POST['uasp_signup_block_color']);}
    if (isset($_POST['uasp_signup_block_margin'])) {update_option('EWD_UASP_Signup_Block_Margin',  $_POST['uasp_signup_block_margin']);}
    if (isset($_POST['uasp_signup_block_padding'])) {update_option('EWD_UASP_Signup_Block_Padding',  $_POST['uasp_signup_block_padding']);}

    if (isset($_POST['uasp_service_title_font'])) {update_option('EWD_UASP_Service_Title_Font',  $_POST['uasp_service_title_font']);}
    if (isset($_POST['uasp_service_title_font_size'])) {update_option('EWD_UASP_Service_Title_Font_Size',  $_POST['uasp_service_title_font_size']);}
    if (isset($_POST['uasp_service_title_font_color'])) {update_option('EWD_UASP_Service_Title_Font_Color',  $_POST['uasp_service_title_font_color']);}
    if (isset($_POST['uasp_service_label_font'])) {update_option('EWD_UASP_Service_Label_Font',  $_POST['uasp_service_label_font']);}
    if (isset($_POST['uasp_service_label_font_size'])) {update_option('EWD_UASP_Service_Label_Font_Size',  $_POST['uasp_service_label_font_size']);}
    if (isset($_POST['uasp_service_block_color'])) {update_option('EWD_UASP_Service_Block_Color',  $_POST['uasp_service_block_color']);}
    if (isset($_POST['uasp_service_block_margin'])) {update_option('EWD_UASP_Service_Block_Margin',  $_POST['uasp_service_block_margin']);}
    if (isset($_POST['uasp_service_block_padding'])) {update_option('EWD_UASP_Service_Block_Padding',  $_POST['uasp_service_block_padding']);}

	if (isset($_POST['uasp_appointment_title_font'])) {update_option('EWD_UASP_Appointment_Title_Font',  $_POST['uasp_appointment_title_font']);}
    if (isset($_POST['uasp_appointment_title_font_size'])) {update_option('EWD_UASP_Appointment_Title_Font_Size',  $_POST['uasp_appointment_title_font_size']);}
    if (isset($_POST['uasp_appointment_title_font_color'])) {update_option('EWD_UASP_Appointment_Title_Font_Color',  $_POST['uasp_appointment_title_font_color']);}
    if (isset($_POST['uasp_appointment_label_font'])) {update_option('EWD_UASP_Appointment_Label_Font',  $_POST['uasp_appointment_label_font']);}
    if (isset($_POST['uasp_appointment_label_font_size'])) {update_option('EWD_UASP_Appointment_Label_Font_Size',  $_POST['uasp_appointment_label_font_size']);}
    if (isset($_POST['uasp_appointment_block_color'])) {update_option('EWD_UASP_Appointment_Block_Color',  $_POST['uasp_appointment_block_color']);}
    if (isset($_POST['uasp_appointment_block_margin'])) {update_option('EWD_UASP_Appointment_Block_Margin',  $_POST['uasp_appointment_block_margin']);}
    if (isset($_POST['uasp_appointment_block_padding'])) {update_option('EWD_UASP_Appointment_Block_Padding',  $_POST['uasp_appointment_block_padding']);}
	
	if (isset($_POST['uasp_button_font'])) {update_option('EWD_UASP_button_Font',  $_POST['uasp_button_font']);}
    if (isset($_POST['uasp_button_font_size'])) {update_option('EWD_UASP_button_Font_Size',  $_POST['uasp_button_font_size']);}
    if (isset($_POST['uasp_button_font_color'])) {update_option('EWD_UASP_button_Font_Color',  $_POST['uasp_button_font_color']);}
    if (isset($_POST['uasp_button_color'])) {update_option('EWD_UASP_Button_Color',  $_POST['uasp_button_color']);}
    if (isset($_POST['uasp_button_margin'])) {update_option('EWD_UASP_Button_Margin',  $_POST['uasp_button_margin']);}
    if (isset($_POST['uasp_button_padding'])) {update_option('EWD_UASP_Button_Padding',  $_POST['uasp_button_padding']);}
