...
function EWD_UASP_Add_Modified_Styles() {
	...
	$StylesString .=".ewd-uasp-das-registrationform-label { ";
		...
		if (get_option("EWD_UASP_Signup_Title_Font_Size") != "") {$StylesString .= "font-size:" .  get_option("EWD_UASP_Signup_Title_Font_Size") . " !important;";} 
	...
	$StylesString .=".ewd-uasp-das-registrationform-content { ";
		...
		if (get_option("EWD_UASP_Signup_Label_Font_Size") != "") {$StylesString .="font-size:" . get_option("EWD_UASP_Signup_Label_Font_Size") . " !important;";} 
		$StylesString .="}\n";	
	...
	if (get_option("EWD_UASP_Service_Title_Font") != "") {$StylesString .= "font-family:" .  get_option("EWD_UASP_Service_Title_Font") . " !important;";} 
		if (get_option("EWD_UASP_Service_Title_Font_Size") != "") {$StylesString .= "font-size:" .  get_option("EWD_UASP_Service_Title_Font_Size") . " !important;";} 
	...
	$StylesString .=".ewd-uasp-das-service-content { ";
		...
		if (get_option("EWD_UASP_Service_Label_Font_Size") != "") {$StylesString .="font-size:" . get_option("EWD_UASP_Service_Label_Font_Size") . " !important;";} 
		$StylesString .="}\n";
	$StylesString .=".ewd-uasp-das-findappointment-label { ";
		...
		if (get_option("EWD_UASP_Appointment_Title_Font_Size") != "") {$StylesString .= "font-size:" .  get_option("EWD_UASP_Appointment_Title_Font_Size") . " !important;";} 
	...
	$StylesString .=".ewd-uasp-das-findappointment-content { ";
		...
		if (get_option("EWD_UASP_Appointment_Label_Font_Size") != "") {$StylesString .="font-size:" . get_option("EWD_UASP_Appointment_Label_Font_Size") . " !important;";} 
		$StylesString .="}\n";
	$StylesString .=".ewd-uasp-das-book-button-container input[type='submit'], .ewd-uasp-das-findappointment button { ";
		...
		if (get_option("EWD_UASP_Button_Font_Size") != "") {$StylesString .= "font-size:" .  get_option("EWD_UASP_Button_Font_Size") . " !important;";} 
	...
	$StylesString .=".fc-title, .fc-time { ";
		...
		if (get_option("EWD_UASP_Calendar_Appointment_Font_Size") != "") {$StylesString .= "font-size:" .  get_option("EWD_UASP_Calendar_Appointment_Font_Size") . " !important;";}
