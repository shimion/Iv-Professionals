<div class="EWD_UASP_Menu">
	<h2 class="nav-tab-wrapper">
		...
		<a id="Settings_Menu" class="MenuTab nav-tab <?php if ($Display_Page == 'Settings') {echo 'nav-tab-active';}?>" onclick="ShowTab('Settings');"><?php _e("Settings", 'ultimate-appointment-scheduling'); ?></a>
	</h2>
</div>
